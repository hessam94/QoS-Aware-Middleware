...
as the target, we train a nueral network model. This model can estimate teh QoE(subjective output) beased on the video distortion rate. So we can balance the video resolution based on the
network situation in real time. 
